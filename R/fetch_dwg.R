#' fetch_dwg
#'
#' Fetch freshwater recreational fishery creel datasets from Washington's public data warehouse data.wa.gov
#'
#' @param fishery_name Name which represents the spatiotemporal configuration for a given dataset with associated fishery closures.
